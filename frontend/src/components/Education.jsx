    ...
    <section id="education" className="py-20 px-6 bg-[#0f0f11]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* University Info */}
          <Card className="md:col-span-1 border border-[#A35C7A]/20 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-[#2a2a2a]">
            <CardHeader className="bg-[#A35C7A] text-white border-b border-[#A35C7A]/20">
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center text-[#C890A7]">
          ...
          {/* Coursework */}
          <Card className="md:col-span-1 border border-[#A35C7A]/20 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-[#2a2a2a]">
            <CardHeader className="bg-[#C890A7] text-white border-b border-[#A35C7A]/20">
              <div className="flex items-center">
            ...
            <CardContent className="p-6">
              <div className="space-y-3">
                {education.relevantCoursework.map((course, index) => (
                  <div key={index} className="p-2 bg-[#3a3a3a] rounded-lg border-l-3 border-[#C890A7]">
              ...
              <div className="space-y-4">
                {education.achievements.map((achievement, index) => (
                  <div key={index} className="flex items-start">
                    <div className="w-3 h-3 bg-[#C890A7] rounded-full mt-2 mr-3 flex-shrink-0"></div>
        ...
        {/* Academic Stats */}
        <div className="mt-16">
          <Card className="border border-[#A35C7A]/20 shadow-lg bg-[#2a2a2a]">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-[#FBF5E5] mb-8 text-center">Academic Highlights</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div className="p-6 bg-[#3a3a3a] rounded-lg border border-[#A35C7A]/20">
                  <div className="text-3xl font-bold text-[#C890A7] mb-2">2nd</div>
                  <div className="text-[#FBF5E5]/70">Year Student</div>
                </div>
                <div className="p-6 bg-[#3a3a3a] rounded-lg border border-[#A35C7A]/20">
                  <div className="text-3xl font-bold text-[#C890A7] mb-2">6+</div>
                ...
                <div className="p-6 bg-[#3a3a3a] rounded-lg border border-[#A35C7A]/20">
                  <div className="text-3xl font-bold text-[#C890A7] mb-2">4.0</div>
