          ...
          <Card className="border border-[#8A5A94]/20 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-[#2a2a2a]">
            <CardContent className="p-8">
              <div className="flex items-center mb-6">
                <Zap className="text-[#A885C4] mr-3" size={24} />
            ...
            <CardContent className="p-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {aboutInfo.hobbies.map((hobby, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-center p-3 rounded-lg bg-[#3a3a3a] hover:bg-[#4a4a4a] transition-colors border border-[#8A5A94]/10">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {aboutInfo.currentlyLearning.map((item, index) => (
                <Badge 
                  key={index}
                  variant="secondary" 
                  className="bg-[#8A5A94] text-white hover:bg-[#A885C4] px-4 py-2 text-sm font-medium border border-[#8A5A94]"
                >
                  {item}
                </Badge>
              ))}
